 ...
 * @since 101.0.0
 */
class CustomDynamic extends AbstractModifier
{
    /**#@+
     * Group values
     */
    ...
    const BUTTON_ADD_IMAGE = 'button_image';
    const BUTTON_UPLOAD_IMAGE='upload';
    /**#@-*/
    ...
    const CONTAINER_COMMON_CODE = 'container_common_code';
    const CONTAINER_COMMON_COMMENT = 'container_common_comment';
    ...
    const GRID_OPTIONS_IMAGE = 'optionsIMG';
            ...
            [
                $this->locator->getProduct()->getId() => [
                    static::DATA_SOURCE_DEFAULT => [
                        ...
                        static::GRID_OPTIONS_IMAGE => $options,
            ...
            [
                static::GROUP_CUSTOM_OPTIONS_NAME => [
                    ...
                    'children' => [
                        ...
                        static::GRID_OPTIONS_IMAGE => $this->getOptionsGridImage(40)
                    ]
                ]
            ]
        );
    ...
    protected function getOptionsGridConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        'addButtonLabel' => __('Add Text Code'),
                    ...
                    'children' => [
                        static::CONTAINER_OPTION => [
                            ...
                            'children' => [
                                ...
                                static::CONTAINER_COMMON_CODE => $this->getCommonContainerConfigCode(10),
                                static::CONTAINER_COMMON_COMMENT => $this->getCommonContainerConfigComment(10),
...
//                                static::GRID_TYPE_SELECT_NAME => $this->getSelectTypeGridConfig(30)
    ...
    protected function getOptionsGridImage($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        'addButtonLabel' => __('Import Image'),
                        'componentType' => DynamicRows::NAME,
                        'component' => 'Magento_Catalog/js/components/dynamic-rows-import-custom-options',
                        'template' => 'ui/dynamic-rows/templates/collapsible',
                        'additionalClasses' => 'admin__field-wide',
                    ...
                    'children' => [
                        static::CONTAINER_OPTION => [
                            ...
                            'children' => [
                                ...
                                static::CONTAINER_COMMON_COMMENT => $this->getCommonContainerConfigComment(10),
                                static::CONTAINER_COMMON_CODE => $this->getCommonContainerConfigImage(20),
...
//                                static::GRID_TYPE_SELECT_NAME => $this->getSelectTypeGridConfig(30)
     ...
     * @since 101.0.0
     */
    protected function getCommonContainerConfigComment($sortOrder)
    {
        $commonContainer = [
            'arguments' => [
                'data' => [
...
//                static::FIELD_IS_REQUIRE_NAME => $this->getIsRequireFieldConfig(40)
    ...
    protected function getCommonContainerConfigCode($sortOrder)
    {
        $commonContainer = [
            'arguments' => [
                'data' => [
            ...
            'children' => [
                static::FIELD_OPTION_ID => $this->getOptionIdFieldConfig(10),
                static::FIELD_TITLE_GOD => $this->getTitleFieldConfig(
                    20,
                    [
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'label' => __('New Game Code'),
                                    'component' => 'Magento_Catalog/component/static-type-input',
                                    'valueUpdate' => 'input',
                                    'imports' => [
                                        'optionId' => '${ $.provider }:${ $.parentScope }.option_id',
...
//                static::FIELD_IS_REQUIRE_NAME => $this->getIsRequireFieldConfig(40)
    ...
    protected function getCommonContainerConfigImage($sortOrder)
    {
        $commonContainer = [
            'arguments' => [
                'data' => [
...
//                                    'component' => 'Magento_Catalog/component/static-type-input',
                ...
                static::BUTTON_UPLOAD_IMAGE => [
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'title' => __('Browser Image..'),
                                'formElement' => Container::NAME,
                                'componentType' => Container::NAME,
                                'component' => 'Magento_Ui/js/form/components/button',
                                'sortOrder' => 20,
